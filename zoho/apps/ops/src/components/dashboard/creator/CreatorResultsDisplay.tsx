...
export const CreatorResultsDisplay: React.FC<ResultsDisplayProps> = ({ 
  ...
  const handleExport = () => {
    ...
    const filename = statusFilter === 'all' ? 'creator-records-all.txt' : 
                     statusFilter === 'success' ? 'creator-records-success.txt' : 'creator-records-failed.txt';
      ...
      <CardContent>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 w-full md:w-auto">
                <div className="relative flex-1 md:w-64">
                  ...
                  <Input placeholder="Search records..." value={filterText} onChange={(e) => onFilterTextChange(e.target.value)} className="pl-10 h-9" />
                </div>
            ...
            <div className="overflow-hidden rounded-lg border border-border">
                ...
                <table className="w-full">
                    ...
                    <tr>
                        ...
                        <div className="flex items-center space-x-1"><Mail className="h-4 w-4" /><span>{primaryFieldLabel}</span></div>
                        </th>
        ...
        {isComplete && (
          <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/10 rounded-lg border border-green-200 dark:border-green-900">
            ...
            <p className="text-center text-sm text-green-600 dark:text-green-500 mt-1">Successfully processed {successCount} out of {totalToProcess} records</p>
          </div>
        )}
      </CardContent>
    </Card>
