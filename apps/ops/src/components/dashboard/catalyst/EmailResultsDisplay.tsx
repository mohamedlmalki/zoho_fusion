...
export const EmailResultsDisplay: React.FC<ResultsDisplayProps> = ({ 
  results, 
  isProcessing, 
  isComplete,
  totalToProcess,
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "email-results.csv");
  ...
  return (
    <Card className="shadow-medium hover:shadow-large transition-all duration-300">
      <CardHeader className="pb-4">
        ...
        <CardDescription>
          {isProcessing ? 'Sending emails in real-time...' : 
           isComplete ? `All ${totalToProcess} emails have been processed.` : 
           'View results below.'}
        </CardDescription>
      </CardHeader>
