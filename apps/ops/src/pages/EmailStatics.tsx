...
const EmailStatics: React.FC<EmailStaticsProps> = ({ onAddProfile, onEditProfile, onDeleteProfile }) => {
  ...
  }, [toast, fetchInvoices]); // Added fetchInvoices to dependency array to fix linter warning
  ...
  }, [activeProfileName, socketRef.current?.connected, checkApiStatus, fetchInvoices]);
